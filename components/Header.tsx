        ...
        <div className="relative">
          ...
          >
            ...
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-gold to-rose-gold flex items-center justify-center">
              <span className="text-matte-black font-heading font-bold">N</span>
            </div>
            ...
            >
              ...
              <ul className="py-2">
                ...
                <li className="border-t border-white/10 mt-2 pt-2">
                  <button className="w-full px-4 py-3 text-left text-sm text-crimson hover:bg-crimson/10 transition-all flex items-center gap-3">
                    <span className="text-lg">●</span>
                    Sign Out
                  </button>
                </li>
