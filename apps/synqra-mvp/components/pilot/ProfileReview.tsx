...
function StudioLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative overflow-hidden rounded-[30px] border border-white/10 bg-noid-black p-10 shadow-[0_50px_160px_-80px_rgba(212,175,55,0.45)]">
  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6">
      <div className="mb-4 flex items-center justify-between gap-3">
        ...
        <div className="h-px flex-1 bg-noid-gold/40" />
      </div>
      {children}
    </div>
  );
