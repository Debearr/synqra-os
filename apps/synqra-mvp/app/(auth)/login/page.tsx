        ...
        <div className="flex min-h-screen items-center justify-center bg-brand-bg barcode-bg">
            <div className="w-full max-w-md space-y-8 rounded-xl glass-panel p-10 shadow-lg">
                <div className="text-center">
                    <h2 className="text-3xl font-display font-bold tracking-luxury text-white">Welcome back</h2>
                    <p className="mt-2 text-sm text-brand-gray">Sign in to your account</p>
                </div>
                <div className="space-y-6">
                    ...
                    <Button className="w-full bg-brand-teal text-brand-bg hover:bg-brand-teal/90 font-medium h-12 text-base shadow-glow hover:shadow-glow-gold">Sign in</Button>
                </div>
                <div className="text-center text-sm">
                    <Link href="/register" className="font-medium text-brand-teal hover:text-brand-gold transition-colors">
